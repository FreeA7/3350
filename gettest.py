...
def getPic(path):
    ...
    # getPathPic('./3350MMG/MMG3350Defect+Code\u56fe\u724702/TSDFS/', path) #
    # 模糊
    getPathPic('./3350MMG/MMG3350Defect+Code\u56fe\u724702/TSFAS/', path)
    # getPathPic('./3350MMG/MMG3350Defect+Code\u56fe\u724702/TSFIX/', path) #
    # 半截
    ...
    # getPathPic('./3350MMG/MMG3350Defect+Code\u56fe\u724704/TTSPS/', path) #
    # 有图片分辨率奇怪
...
def main():
    ...
    print('一共处理了%d张图片，失败%d张，处理率为%f，共耗时%fs' % (all_sum, error_sum,
                                              (1 - (error_sum / all_sum)), ((all_end - all_start).seconds)))
